...
public class CotizacionBO {
    ...
    // Crear cotización con validación de campos mínimos
    ...
    // Asignar los valores a la cotización
    ...
    // Método para obtener cotización por ID
    ...
    public boolean actualizarCotizacion(Cotizacion c) {
        if (c.getEstado().equalsIgnoreCase("Aceptado") || c.getEstado().equalsIgnoreCase("Rechazada")) {
            System.out.println("No se puede modificar cotización aceptada o rechazada");
            return false;
        }
