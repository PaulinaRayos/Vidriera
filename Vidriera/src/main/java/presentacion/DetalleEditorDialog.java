...
public class DetalleEditorDialog extends javax.swing.JDialog {
    ...
    /**
     * Método público para que frmCrearCotizacion recoja el resultado.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetalleEditorDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//                public void run() {
//                    DetalleEditorDialog dialog = new DetalleEditorDialog(new javax.swing.JFrame(), true);
